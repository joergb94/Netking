            ...
            <div class="row justify-content-between">
                    ...
                    <div class="col-6 theme-2">
                        <div class="row theme-2">
                            ...
                            @endif
                            @if(isset($cardItems[6]) && isset($cardItems[6]['item']))
                    ...
                    @endif
                    @if(isset($cardItems[7]) && isset($cardItems[7]['item']))
                    ...
                    @if(isset($cardItems[$i]) && isset($cardItems[$i]['item']))
                    <div class="col-6 theme-2" >
                        <div class="row theme-2">
                            @if(isset($cardItems[$i]) && isset($cardItems[$i]['item']))
                            ...
                            @endif
                            @if(isset($cardItems[$i+1]) && isset($cardItems[$i+1]['item']))
                    ...
                    @endif
                    @if(isset($cardItems[$i+2]) && isset($cardItems[2]['item']))
                        <div class="col-6 theme-2">
                        <div class="row theme-2">
                            @if(isset($cardItems[$i+2]) && isset($cardItems[$i+2]['item']))
                            ...
                            @endif
                            @if(isset($cardItems[$i+3]) && isset($cardItems[$i+3]['item']))
                            ...
                            @endif
                            @if(isset($cardItems[$i+4])&& isset($cardItems[$i+4]['item']))
                    ...
                    @endif
                    @if(isset($cardItems[$i+5]) && isset($cardItems[$i+5]['item']))
