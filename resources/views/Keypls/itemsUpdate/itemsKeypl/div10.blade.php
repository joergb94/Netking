        ...
        <button class="btn btn-link-keypl btn-full-screen {{$card_style['button_style'] == 0? 'keypl-btn ':'keypl-btn-full'}} btn-block {{!$btn_shape?'':'theme-'.$data['themes_id'].'-btn-rounded'}}" value="{{$ci['card_detail']['id']}}" >
            <div class="col-12">
