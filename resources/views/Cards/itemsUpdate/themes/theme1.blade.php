            ...
            <div class="row justify-content-between">
                ...
                <div class="col-6 theme1-col-6" id="div-{{$cardItems[2]['card_detail']->id}}">
                        @include('Cards.itemsUpdate.itemsKeypl.div'.$cardItems[2]['item']->id,['ci' => $cardItems[2],'template'=>315,'theme_shape'=>'theme1-shape'])
                </div>
                @endif
                <div class="col-6 theme1-col-6">
                    <div class="row">
                        ...
                        <div class="col-12 theme1-col" id="div-{{$cardItems[3]['card_detail']->id}}">
                                @include('Cards.itemsUpdate.itemsKeypl.div'.$cardItems[3]['item']->id,['ci' => $cardItems[3],'template'=>'110','theme_shape'=>'theme1-shape'])
                
                        </div>
                        @endif
                        @if(isset($cardItems[4]))
                        <div class="col-12 theme1-col" id="div-{{$cardItems[4]['card_detail']->id}}">
                                @include('Cards.itemsUpdate.itemsKeypl.div'.$cardItems[4]['item']->id,['ci' => $cardItems[4],'template'=>'110','theme_shape'=>'theme1-shape'])
                
                        </div>
                        @endif
                        @if(isset($cardItems[5]))
                        <div class="col-12 theme1-col" id="div-{{$cardItems[5]['card_detail']->id}}">
                                @include('Cards.itemsUpdate.itemsKeypl.div'.$cardItems[5]['item']->id,['ci' => $cardItems[5],'template'=>'110','theme_shape'=>'theme1-shape'])
                        </div>
                        @endif
                     </div>
                </div>
