        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <div class="input-group mb-3 group-social">
                    ...
                    <input type="text" class="form-control form-control-sm n-social" onchange="Cards.save_asinc({{$social['nsData']['card_id']}})" value ="{{isset($social['nsUser'])?$social['nsUser']['url']:''}}"  id="{{$social['nsData']['name']}}" >
