        ...
        <a  
         style="height:{{$template == 0?315:$template}}px;"
         onmousedown="return false" 
         class="btn btn-link-keypl btn-full-screen-edit {{$card_style['button_style'] == 0? 'keypl-btn ':'keypl-btn-full'}} btn-block {{!$btn_shape?'':'theme-'.$data['themes_id'].'-btn-rounded'}}"  
         target="_blank" 
         href="{{$ci['card_detail']['description']}}" >
