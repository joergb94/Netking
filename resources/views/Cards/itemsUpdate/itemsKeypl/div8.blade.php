...
<a  style="height:{{$template == 0?315:$template}}px;"
    value="{{$ci['card_detail']['id']}}" href="{{$ci['card_detail']['description']}}"  
    class="btn btn-full-screen-edit {{$card_style['button_style'] == 0? 'keypl-btn ':'keypl-btn-full'}} {{!$btn_shape?'':'theme-'.$data['themes_id'].'-btn-rounded'}} btn-block" 
    download>
