...
<button value="{{$ci['card_detail']['id']}}"  class="btn btn-full-screen {{$card_style['button_style'] == 0? 'keypl-btn ':'keypl-btn-full'}} {{!$btn_shape?'':'theme-'.$data['themes_id'].'-btn-rounded'}} btn-block" download>
    <div class="col-12">
