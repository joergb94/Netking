    ...
    <div class="row no-margin">
        ...
        <div class="col-sm-12" id="contend-title">
                ...
                <div class="col-6 text-center" style="left:40%;">
                    ...
                    <span class="d-none d-md-block d-lg-block d-xl-block" >follow <i class="fas fa-user-plus"></i></span>
                    <i class="fas fa-user-plus d-block d-sm-block d-md-none d-lg-none d-xl-none"></i>
                </div>         
        </div>
    </div>
    @else
