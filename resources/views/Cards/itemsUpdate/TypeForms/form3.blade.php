<div class="col-12">
  ...
  <button type="button" class="btn btn-link" onclick="Cards.back_principal()"> <h4 class="text-dark"> <i class="fas fa-angle-left"></i> Agregar Video de Youtube <span class="fa fa-youtube" aria-hidden="true"></span></h4></button></div>
  <div class="card-body">
